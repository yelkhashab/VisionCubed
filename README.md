...
**Designed to run with corresponning backend:**
https://github.com/yelkhashab/VisionCubed-API
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/yelkhashab/VisionCubed.git
   ```
...
This command starts the local development server. You can view your application by opening http://localhost:3000 (or the URL provided in your terminal) in your web browser.
